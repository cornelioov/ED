...
BTNode<T>::BTNode (T const& it, BTNode<T>::Ref l,
                   BTNode<T>::Ref r)
{
    //TODO  BTNode (T const& it, BTNode<T>::Ref l,BTNode<T>::Ref r)
...
{
    //TODO set_left(BTNode<T>::Ref new_child)
...
{
    //TODO set_right(BTNode<T>::Ref new_child)
